...
public class DialogueGraphView : GraphView
{
    ...
    private void AddManipulators()
    {
        ...
        this.AddManipulator(CreateNodeContextualMenu("Add Start Node", DialogueType.Start));
        ...
        this.AddManipulator(CreateNodeContextualMenu("Add Node (Event)", DialogueType.Event));
    ...
    private void OnGraphViewChanged()
    {
        graphViewChanged = (changes) =>
        {
            if (changes.edgesToCreate != null)
            {
                ...
                {
                    if (edge.input?.node is not DLNode nextNode)
                    {
                        continue;
                    }
